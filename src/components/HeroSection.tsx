    ...
    <section id="hero" className="bg-[#1B2438] pt-28 md:pt-36 pb-0 text-[#F8FAFC] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center flex flex-col items-center">
          ...
          {/* Eyebrow badge */}
          <div className="inline-flex items-center gap-2.5 px-4 py-2 rounded-full bg-[#121826] border border-[#2A364F] text-xs font-mono uppercase tracking-[0.2em] text-[#FBBF24] mb-8 shadow-md hover:border-[#F59E0B]/60 transition-colors">
          ...
          {/* Key value signals */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 w-full max-w-3xl pt-8 pb-12 border-t border-[#2A364F]/70 text-left">
