...
export const PROJECTS: Project[] = [
  {
    ...
    year: '2024',
    status: 'Live',
    liveUrl: 'https://wedding-invitations-builder.web.app/',
  ...
  },
  {
    ...
    year: '2025',
    status: 'Live',
    liveUrl: 'https://ethio-shein.web.app/',
  ...
  },
  {
    ...
    year: '2025',
    status: 'Live',
    liveUrl: 'https://etex-hrms.web.app/',
    repo: 'github.com/yareds/hr-system',
    tagline: 'Comprehensive employee lifecycle & automated payroll engine',
    description: 'A full-scale enterprise human resources platform — employee directory, onboarding workflows, automated payroll processing with tax calculations, leave management, and role-based security access control.',
    stack: ['React 19', 'TypeScript', 'Vite', 'Tailwind CSS', 'Motion'],
    features: [
      'Employee directory and digital onboarding workflows',
      'Automated payroll & tax calculation engine',
      'Leave request tracking with multi-level manager approvals',
      'Performance evaluation and goal tracking',
      'Role-based permissions (Admin, HR Manager, Employee)'
    ],
    accent: 'brass',
    architectureHighlights: [
      'Modular RBAC security framework safeguarding sensitive employee records and compensation data',
      'Automated payroll calculation engine supporting custom tax brackets and direct deposit breakdowns',
      'Reactive state orchestration for real-time leave quota tracking and attendance analytics'
    ],
    targetAudience: 'Growing enterprises, corporate HR departments, and mid-sized organization operational teams.'
  },
  {
    ...
    year: '2025',
    status: 'Live',
    liveUrl: 'https://getch-property-manager.web.app/',
  ...
  },
  {
    ...
    name: 'YONIMobile Auction',
    category: 'Marketplace',
    year: '2025',
    status: 'Live',
    liveUrl: 'https://etphone-auction.web.app/',
